...
OrdersAgentModel ordersAgentModelFromJson(String str) => OrdersAgentModel.fromJson(json.decode(str));

String ordersAgentModelToJson(OrdersAgentModel data) => json.encode(data.toJson());

class OrdersAgentModel {
  List<Order> orders;
  ...
  factory OrdersAgentModel.fromJson(Map<String, dynamic> json) => OrdersAgentModel(
    orders: List<Order>.from(json["orders"].map((x) => Order.fromJson(x))),
    paginationOrdersUser: PaginationOrdersUser.fromJson(json["paginationOrdersUser"]),
  );
